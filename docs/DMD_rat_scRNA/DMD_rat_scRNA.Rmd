...
```{r QC_plots_filtered, echo=FALSE, fig.height=10, fig.width=12}
...
```{r go_enrichment, echo=FALSE, fig.height=8, fig.width=10, message=FALSE, warning=FALSE}
...
(AKA Co-expression network analysis. Though we don't seem to have enough samples for this task.)

*This part follows the [tutorial](https://smorabit.github.io/hdWGCNA/articles/basic_tutorial.html) on hdWGCNA package website.*

### Set up Seurat object for WGCNA

```{r setup_for_WGCNA, echo=TRUE}
